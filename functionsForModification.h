...
//figure
void creatingFigures(std::array<Figure*, 30>& arrayOfFigurePointers);//9

void hideAll(std::array<Figure*, 30>& arrayOfFigurePointers);//y
void hideCircular(std::array<Figure*, 30>& arrayOfFigurePointers);//t
void hideQuadrangle(std::array<Figure*, 30>& arrayOfFigurePointers);//u

void increaseRadius(std::array<Figure*, 30>& arrayOfFigurePointers);//z
void decreaseRadius(std::array<Figure*, 30>& arrayOfFigurePointers);//x

void increaseLength(std::array<Figure*, 30>& arrayOfFigurePointers);//c
#endif