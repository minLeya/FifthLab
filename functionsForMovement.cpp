...
void moveRight(std::array<Figure*, 30>& arrayOfFigurePointers)
{
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right))
    {
...
void moveCircularRight(std::array<Figure*, 30>& arrayOfFigurePointers)
{
...
void moveCircularLeft(std::array<Figure*, 30>& arrayOfFigurePointers)
{
...
void moveCircularUp(std::array<Figure*, 30>& arrayOfFigurePointers)
{
...
void moveCircularDown(std::array<Figure*, 30>& arrayOfFigurePointers)
{
...
void moveQuadrangularRight(std::array<Figure*, 30>& arrayOfFigurePointers)
{
...
void moveQuadrangularLeft(std::array<Figure*, 30>& arrayOfFigurePointers)
{
...
void moveQuadrangularUp(std::array<Figure*, 30>& arrayOfFigurePointers)
{
...
void moveQuadrangularDown(std::array<Figure*, 30>& arrayOfFigurePointers)
{
